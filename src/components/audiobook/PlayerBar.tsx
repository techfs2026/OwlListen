  ...
  return (
    <div className="player-bar">
      <div className="player-bar__seek-row">
        ...
        <div
          className="player-bar__progress-area"
          ref={trackRef}
      ...
      <div className="player-bar__controls">
        <div className="player-bar__zone player-bar__zone--left">
          ...
          >
            <span className="player-bar__autoplay-label">连播</span>
            <span className="player-bar__switch" aria-hidden="true">
              <span className="player-bar__switch-knob" />
            </span>
          </button>
        </div>
