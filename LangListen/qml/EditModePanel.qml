...
Item {
    ...
    function loadSegment(index) {
        ...
        if (playbackController && playbackController.duration > 0) {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    if (currentEditIndex > 0) {
                        loadSegment(currentEditIndex - 1)
                    }
                }
            }
            ...
            Button {
                ...
                Layout.preferredWidth: 50
                Layout.preferredHeight: 28
                enabled: currentEditIndex >= 0 && currentEditIndex < appController.segmentCount - 1
                ...
                onClicked: {
                    if (currentEditIndex < appController.segmentCount - 1) {
                        loadSegment(currentEditIndex + 1)
                    }
                }
            }
            ...
            SpinBox {
                id: jumpToSpinBox
                from: 1
                to: Math.max(1, appController.segmentCount)
                value: currentEditIndex >= 0 ? currentEditIndex + 1 : 1
                editable: true
                Layout.preferredWidth: 100
            ...
            Button {
                ...
                onClicked: {
                    var targetIndex = jumpToSpinBox.value - 1
                    if (targetIndex >= 0 && targetIndex < appController.segmentCount) {
        ...
        Label {
            Layout.fillWidth: true
            text: "提示: 在转写完成后，点击句子列表中的项目开始编辑。使用 ← → 按钮可以从播放位置快速设置时间。"
            font.pixelSize: 11
            color: "#9e9e9e"
            wrapMode: Text.Wrap
        }
